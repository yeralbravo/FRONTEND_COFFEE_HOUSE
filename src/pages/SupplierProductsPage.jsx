    // src/pages/SupplierProductsPage.jsx
    ...
    return (
        ...
        <header className="page-header">
            ...
            onClick={() => navigate('/supplier/item/create?type=product')}
            >
            <FiPlus /> Añadir Café
            </button>
        </header>
            ...
            <table className="product-table">
                ...
                {products.length > 0 ? (
                    ...
                    <tr key={product.id}>
                        ...
                        <img
                            ...
                            product.images.length > 0
                                ? product.images[0] // ✅ ya es URL absoluta
                        ...
                        <div className="action-buttons">
                            <button
                            onClick={() =>
                                navigate(`/supplier/item/edit/product/${product.id}`)
                            }
                    ...
                    <td colSpan="5" className="no-results-cell">
                        No se encontraron cafés con ese nombre.
                    </td>
                    </tr>
                )}
                </tbody>
