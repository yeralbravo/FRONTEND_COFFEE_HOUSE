    // src/pages/SupplierInsumosPage.jsx
    ...
    const handleDelete = (insumoId) => {
        showConfirmDialog({
        title: '¿Estás seguro?',
        text: 'Este insumo se eliminará permanentemente.',
        }).then(async (result) => {
    ...
    return (
        ...
        <header className="page-header">
            ...
            onClick={() => navigate('/supplier/item/create?type=insumo')}
            >
            ...
            <table className="product-table">
                ...
                {insumos.length > 0 ? (
                    ...
                    <tr key={insumo.id}>
                        ...
                        <img
                            src={
                            insumo.images.length > 0
                                ? insumo.images[0] // ✅ ya es URL absoluta
                        ...
                        ${new Intl.NumberFormat('es-CO').format(insumo.precio)}
                        </td>
                        <td data-label="Stock">
                        <span
                        ...
                        <div className="action-buttons">
                            <button
                            onClick={() =>
                                navigate(`/supplier/item/edit/insumo/${insumo.id}`)
                            }
